...
Write a team-driven-development implementation plan from a spec. Replaces `superpowers:writing-plans` inside this plugin. Plans are hybrid-density (execution artifacts inline, rationale referenced); Sprint Contract files live separately under `docs/team-dd/sprints/<topic>/`, generated by `sprint-master` after the plan is written.
...
- Spec and plan paths are the sole validation surface; Sprint Contract content is owned by `sprint-master` and lives under `docs/team-dd/sprints/<topic>/`.
