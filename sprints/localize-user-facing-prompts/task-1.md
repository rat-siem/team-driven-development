...
- [ ] After edit, all six files contain the canonical single-paragraph block: heading `## Language Policy`, paragraph beginning "Render user-facing prose", containing "Keep literal: commands, paths" and "Default to match recent user input".
